...
class App{
  ...
  public function auth(){
    //Comprueba que existe el nombre y guarda el nombre y la contraseña
    ...
    //Crea 2 cookies, con el nombre y la contraseña
  ...
  public function close(){
    ...
    //caduca la cookie del nombre y la password
    setcookie("nombre", "",  -7200);
    setcookie("password", "",  -7200);
